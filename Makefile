...
help:
	...
	@echo ""
	@echo "Configuration:"
	@echo "  Edit internal/camera/config.go to change resolution/FPS"
	@echo ""
	@echo "Current settings:"
	@grep -E "Camera(Width|Height|FPS|Format)" internal/camera/config.go 2>/dev/null | grep "=" | head -4 || echo "  (config.go not found)"
